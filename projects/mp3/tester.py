...
def main():
    ...
    if count == original_count:
        result_module["errors"].append("Additional points/test cases were not added to module_tester.")
    # ========================= MP3 ONLY ========================= 
    ...
    result = {
        ...
        "summary": f"Result: Score of {score}% as average of {result_module['score']}% (modules) and {result_notebook['score']}% (notebook)."
    }
