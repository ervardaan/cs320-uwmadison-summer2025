...
1. Go to the Google Cloud Console at https://console.cloud.google.com/.  Then sign into your account.  Be sure your @wisc.edu user is selected (top right corner) and that the "cs320-YOUR-SEMESTER" project is also selected (to the left of the search box in the blue bar)!
...
<img src="img/Compute_Engine_API.png" width=300>
